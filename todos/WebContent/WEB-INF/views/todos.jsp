...
<script>
	function refreshList(pageNo, event) {
		if (event) {	// <a> 태그를 클릭한 경우만 event가 undefined가 아님
			event.preventDefault();
		}
		// <form> 안의 <input type="hidden" name="pageNo" />의 값을 설정
		// 페이지 번호를 클릭한 경우만 1이 아닌 다른 값이 들어감
		...
		// <form>안의 row, status, keyword, pageNo 입력요소의 값을 서버로 제출
