...
<body>
	...
	<form method="POST" action="page1.jsp">
		<div>
			<label>PageContext에 저장할 값을 입력</label>
			<div>
				<input type="text" name="value1">
			</div>
		</div>
		<div>
			<label>HttpServletRequest에 저장할 값을 입력</label>
			<div>
				<input type="text" name="value2">
			</div>
		</div>
		<div>
			<label>HttpSession에 저장할 값을 입력</label>
			<div>
				<input type="text" name="value3">
			</div>
		</div>
		<div>
			<label>ServletContext에 저장할 값을 입력</label>
			<div>
	...
	<div>
		<p><a href="page2.jsp">page2로 이동</a></p>
		<p><a href="page3.jsp">page3로 이동</a></p>
	</div>
