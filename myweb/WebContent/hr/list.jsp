...
<div class="wrapper">
	...
	%>
		...
		<%
			...
			// 4. 요청한 페이지가 어느 페이지 블록에 속하는지 계산
			int currentBlock = (int) Math.ceil((double) pageNo/pagesPerBlock);
			
			// 5. 요청한 페이지가 속한 블록의 시작페이지 번호와 끝 페이지 번호 계산
